...
const productsServiceTest_1 = require("../../domain/productsService/productsServiceTest");
...
exports.testsRouter.get("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    console.log("HEllo");
    const reqQueryTitle = req.query.title;
    const foundProducts = yield productsServiceTest_1.productsServiceTest
...
exports.testsRouter.get("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const reqParamsProductID = req.params.id;
    const foundProductByID = yield productsServiceTest_1.productsServiceTest
...
exports.testsRouter.delete("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const reqParamsID = req.params.id;
    const deletedMessage = yield productsServiceTest_1.productsServiceTest.deleteProductByID(reqParamsID);
    const deleteStatus = {
        msg: deletedMessage
            ? "Product was deleted"
...
exports.testsRouter.post("/", index_1.productFieldsValidation, index_1.errorsHandler, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { title, count, price } = req.body;
    const newProduct = yield productsServiceTest_1.productsServiceTest
        .createProduct({
        title,
        count,
        price,
...
exports.testsRouter.put("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const reqParamsID = req.params.id;
    const { title, count, price } = req.body;
    const changeProduct = yield productsServiceTest_1.productsServiceTest
